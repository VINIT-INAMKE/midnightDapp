    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12 text-center">
          <div className="bg-card backdrop-blur-md rounded-3xl p-8 shadow-xl border border-border">
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              <input
                type="text"
                className="block w-full pl-12 pr-4 py-4 text-lg border-2 border-input rounded-xl bg-background text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {filteredCourses.map((course) => (
              <div
                key={course.id}
                className="group bg-card backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-border"
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-3 line-clamp-2 group-hover:text-secondary transition-colors duration-200">
                    <Link href={`/course-details/${course.slug}`}>
                      {course.title}
                    </Link>
                  </h3>
                  ...
                  <div className="flex items-center space-x-2 mb-4">
                    <div className="flex items-center">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`w-5 h-5 ${i < Math.floor(course.average_rating)
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border">
                    ...
                    <div className="flex items-center space-x-3">
                      <button
                        ...
                        className="p-2.5 text-muted-foreground hover:text-secondary hover:bg-secondary/10 rounded-full transition-colors duration-200"
                      >
                        <ShoppingCart className="w-6 h-6" />
                      </button>
                      <Link
                        href={`/course-details/${course.slug}`}
                        className="inline-flex items-center px-4 py-2.5 text-sm font-medium text-secondary-foreground bg-secondary rounded-lg hover:bg-secondary/90 transition-colors duration-200"
                      >
                        Enroll Now
        ...
        <section className="mt-20">
          <div className="bg-gradient-to-r from-primary to-primary/90 rounded-3xl overflow-hidden shadow-2xl border border-border">
              ...
              <div className="relative p-10 lg:p-16">
                <div className="relative z-10">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center px-8 py-4 bg-secondary text-secondary-foreground rounded-xl font-semibold hover:bg-secondary/90 transition-all duration-200 transform hover:-translate-y-0.5 hover:shadow-lg"
                  >
